...
namespace UniVerein.DAL.Migrations
{
    ...
    [Migration("20260913122352_MakePendingEnrollmentCategoryOptionalAddMotivation")]
    partial class MakePendingEnrollmentCategoryOptionalAddMotivation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniVerein.DAL.Entities.ReceiptEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("UniVerein.DAL.Entities.ReceiptFileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("UniVerein.DAL.Entities.UserSettingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("UniVerein.DAL.Entities.WebPageConfigEntity", b =>
                {
                    ...
                    b.Property<bool>("SelfEnrollmentEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("self_enrollment_enabled");
            ...
            modelBuilder.Entity("UniVerein.DAL.Entities.ReceiptEntity", b =>
                {
                    b.HasOne("UniVerein.DAL.Entities.ReceiptCategoryEntity", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("UniVerein.DAL.Entities.ReceiptFileEntity", b =>
                {
                    b.HasOne("UniVerein.DAL.Entities.ReceiptEntity", "Receipt")
                        .WithMany("Files")
